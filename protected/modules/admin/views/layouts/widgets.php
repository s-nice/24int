            ...
            <div class="page-sidebar ">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper"> 
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class=""> 
                            <a id="menu_1_1" href="<?php echo Yii::app()->controller->createUrl('default/index'); ?>">
                                <i class="fa fa-dashboard"></i>
                                <span class="title">Dashboard</span>
                            </a>
                        </li>
                        <li> 
                            <a id="menu_1_2" href="widgets.html">
                                <i class="fa fa-th"></i>
                        ...
                        <li class=""> 
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a id="menu_2_1" class="" href="<?php echo Yii::app()->controller->createUrl('user/admin'); ?>">用户管理</a>
                                </li>
                                <li>
                                    <a class="" href="ui-googlemaps.html">权限管理</a>
                                </li>
                                <li>
                                    <a class="" href="ui-googlemapfull.html">菜单管理</a>
                                </li>
								<li>
                                    <a class="" href="ui-googlemapfull.html">网站设置</a>
                                </li>
                            </ul>
                        </li>
